...
try {
  ...
  await page.route('http://127.0.0.1:19349/**', async route => {
    ...
    if (path.endsWith('.mjs')) return route.fulfill({ contentType: 'text/javascript', body: await readFile(new URL('./deepseek_harness_voice_feedback.mjs', import.meta.url), 'utf8') })
